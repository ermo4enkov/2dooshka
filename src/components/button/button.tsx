...
const StyledButton = styled.div`
    ...
    border: ${(props: ButtonProps) => (props.disabled === true || props.isLoading === true) ?
         "solid 1px #d0d8dc;" : "none"};
    background-color: ${(props: ButtonProps) => (props.disabled === true || props.isLoading === true) ? 
        "#f6f7f8" : ""};
    min-width: 80px;
    box-shadow: ${(props: ButtonProps) => props.hover === true ?
        "inset 0 -2px 0 0 rgba(0, 0, 0, 0.1);" : "none"};
    ...
    render() {
        return (
            <StyledButton {...this.props}
                disabled={this.props.disabled ? this.props.disabled : this.state.isBlocked}
                isLoading={this.props.isLoading ? this.props.isLoading : this.state.isLoaded}
            >
